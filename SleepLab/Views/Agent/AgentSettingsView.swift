...
struct AgentSettingsView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            isEnabled = AgentSettings.isEnabled
            connectionCode = AgentSettings.connectionCode ?? ""
            updateLastSyncText()
        }
    ...
    private func handleToggle(_ newValue: Bool) {
        if newValue {
            // If we already have a key, just re-enable — don't generate a new one
            if let existingCode = AgentSettings.connectionCode, !existingCode.isEmpty {
