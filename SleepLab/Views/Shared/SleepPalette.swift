...
enum SleepPalette {
    ...
    static let panelBackground = Color.dynamic(light: "#FFFFFF", dark: "#1C1C1E", lightOpacity: 0.9, darkOpacity: 0.9)
    static let panelSecondary = Color.dynamic(light: "#F4F7FC", dark: "#2A2D33", lightOpacity: 0.92, darkOpacity: 0.95)
    static let mutedText = Color.dynamic(light: "#475569", dark: "#9AA4B2")
    static let cardStroke = Color.dynamic(light: "#DBE4F2", dark: "#333A48")
    static let chartGrid = Color.dynamic(light: "#DCE3EF", dark: "#2E3645")
    static let chartPlotBackground = Color.dynamic(light: "#F8FAFF", dark: "#11141B")
    static let stageLabelText = Color.dynamic(light: "#5B6472", dark: "#A7AFBC")
